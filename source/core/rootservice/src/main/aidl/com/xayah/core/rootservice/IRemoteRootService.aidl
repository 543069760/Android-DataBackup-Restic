...
interface IRemoteRootService {
    ...
    String rusticRepositoryConfigId(String repositoryPath, in Map options);
    ...
    void pruneRusticRepository(String repositoryPath, String password, in Map options, String maxUnused, boolean instantDelete);
    void listRusticSnapshotsDb(String repositoryPath, String password, in Map options, String dbPath);
    String opendalList(String scheme, String path, in Map options);
    void opendalCreateDir(String scheme, String path, in Map options);
